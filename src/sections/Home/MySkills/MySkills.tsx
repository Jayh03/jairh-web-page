import { MarginContainer, Titles, VerticalCarousel } from '@/components';
...
import {
	imageSliderMain,
	imageSliderMainTwo
} from '@/constants/vertical-carousel';
			...
			<div className={styles.container}>
				...
				<div className={styles.container__content}>
					...
					<div className={styles.container__content__description}>
						<div className={styles.contntOne}>
							<Conten
								parafone={
				...
				<div className={styles.contentTwo}>
					<VerticalCarousel
						itemsList={imageSliderMain}
						itemsListTwo={imageSliderMainTwo}
					/>
				</div>
			</div>
		</MarginContainer>
